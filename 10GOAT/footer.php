                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="address-block mt-30">
                            ...
                            <address class="address-info d-flex align-items-center">
                                ...
                                <p><span>ADDRESS : </span> 470 Tran Dai Nghia, Ngu Hanh Son District</p>
                            </address>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <address class="address-info email mt-30">
                            ...
                            <p><span>EMAIL : </span><a href="emailto:10Goat@gmail.com">10goat@gmail.com</a></p>
                        </address>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <address class="address-info email mt-30">
                            <i class="fa fa-phone"></i>
                            <p><span>PHONE : </span><a href="tel:099-999-999">099-999-999</a></p>
                        </address>
                    </div>
                </div>
            </div>
